...
const PropertiesOptionsLabel = () => {
    ...
    useEffect(() => {
        const targetNode = parse(counterState.value).querySelector(`label${counterState.currentFocus}`);
        if (targetNode) {
...
export default PropertiesOptionsLabel;