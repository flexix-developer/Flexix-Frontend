  ...
  return (
    <div className="h-screen bg-gray-900 ">
      ...
      <div className="bg-gray-900 flex justify-center mt-auto mb-10">
        <span className="text-white font-bold text-4xl">Platform</span>
      </div>
        ...
        <div className="w-5/12 bg-gray-50 p-8 flex justify-center items-center">
          <div>
            <label className="font-bold text-3xl">
              Low-code เป็นวิธีการพัฒนาแอปพลิเคชันที่ยกระดับ
              การเขียนโค้ดจากการใช้ข้อความไปสู่การใช้ส่วนกราฟิก
            </label>
            <br />
            <br />
            <label className="text-2xl">
              <span className="text-blue-400 font-bold ">Low-code</span>{" "}
              คือแพลตฟอร์มหรือเครื่องมือ
              ที่ช่วยให้นักพัฒนาสร้างแอปพลิเคชันโดยไม่ต้องเขียนโค้ดเต็มรูปแบบหรือเขียนน้อยมาก
              มันช่วยลดความซับซ้อนในการพัฒนาแอปพลิเคชันและทำให้การสร้างแอปพลิเคชันเร็วขึ้นและง่ายขึ้น
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-auto bg-gray-900 h-2/4">
        ...
        <div className="w-5/12 bg-gray-50 p-8 flex justify-center items-center">
          <div>
            <label className="font-bold text-3xl">
              Low-code
              มีคุณสมบัติหลายอย่างที่ช่วยให้นักพัฒนาสามารถสร้างแอปพลิเคชันได้อย่างรวดเร็ว
            </label>
            <br />
            <br />
            <label className="text-2xl">
              <span className="text-blue-400 font-bold"></span>{" "}
              การสร้างด้วยการลากและวาง (Drag-and-Drop) สามารถสร้าง
              UIและเพิ่มฟังก์ชันได้โดยใช้การลากและวางองค์ประกอบแบบกราฟิก
              ไม่ต้องเขียนโค้ดเข้าไปเองในกระบวนการนี้
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-auto bg-gray-900 h-2/4">
        ...
        <div className="w-5/12 bg-gray-50 p-8 flex justify-center items-center">
          <div>
            <label className="font-bold text-3xl">
              ในบทบาทของนักพัฒนาซอฟต์แวร์
            </label>
            <br />
            <br />
            <label className="text-2xl">
              <span className="text-blue-400 font-bold">Low-code</span>{" "}
              เป็นเครื่องมือสำคัญในการเพิ่มความเร็วในการพัฒนาโปรแกรมและแอปพลิเคชันโดยช่วยให้ผู้พัฒนาสร้างแอปพลิเคชันได้อย่างง่ายและยืดหยุ่นสามารถเช่นเดียวกับการทำงานของนักพัฒนาซอฟต์แวร์เพิ่มประสิทธิภาพในการจัดการโปรเจกต์ของพวกเขาได
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-auto bg-gray-900 h-2/4">
        ...
        <div className="w-5/12 bg-gray-50 p-8 flex justify-center items-center">
          <div>
            ...
            <br />
            <label className="text-2xl">
              <span className="text-blue-400 font-bold"></span> การพัฒนาแบบ
              low-code ต่างจากการพัฒนาแอปแบบเดิมๆ ที่ต้องเขียนโค้ดมาก โดย
              low-code ช่วยเพิ่มความสามารถในการสร้างแอปหรือเว็บไซต์
              ให้กับผู้คนจำนวนมากโดยใช้ความรู้ขั้นต่ำและเครื่องมือง่าย.
              การพัฒนาแบบเดิมต้องอาศัยนักพัฒนามืออาชีพที่มีความเชี่ยวชาญในการเขียนโค้ดด้วยตนเอง
            </label>
          </div>
        </div>
      </div>
