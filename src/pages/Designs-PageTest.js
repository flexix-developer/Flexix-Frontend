...
import Toolbox from "../components/toolbox/toolboxTest";
import { CgCloseO } from "react-icons/cg";
import { IoMdAdd } from "react-icons/io";
import { parse } from "node-html-parser";
import { currentRowNumber } from "../components/toolbox/Toolbox";

export var root = parse('<html><head><title>Document</title></head><body><div class="main"></div></body></html>');

const DesignPageTest = () => {
