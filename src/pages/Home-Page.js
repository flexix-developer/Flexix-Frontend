      ...
      <div className="flex justify-center items-center flex-1">
        <div className="mx-auto md:flex bg-gray-800 p-8 md:p-12 rounded-lg w-10/12">
          <div className="text-white mr-8 w-full md:w-5/12">
            <p className="text-2xl text-white mb-1">LOW-CODE APPLICATION DEVELOPMENT PLATFORM</p>
            <p className="text-7xl text-white font-bold mb-1">WELCOME TO</p>
            <p className="text-8xl text-orange-600 font-bold mb-2">FLEXiX</p>
            <p className="text-2xl text-white mb-1">Enter the next era of app development</p>
            <p className="text-2xl text-white mb-10">with our platform-wide updates.</p>
