...
import WidgetsTitle from "../components/ToolboxWidgetsTitle";
import WidgetsElement from "../components/ToolboxWidgetsElement";
...
const Toolbox = () => {
  ...
  const handleElementClick = (elementName) => {
   ...
   return (
    <div className="flex flex-col min-h-screen bg-neutral-700 text-white">
